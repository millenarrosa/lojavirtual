<x-app-layout>
    <form x-data="{ imageUrl: null }" enctype="multipart/form-data" class="w-full bg-white p-6 rounded-lg shadow" action="{{ url('products/new') }}" method="POST">
        @csrf
        ...
        <h1 class="text-2xl font-bold mb-6 text-gray-900">Cadastrar Produto</h1>
        ...
        <label class="block mb-1 text-gray-700">Imagem:</label>
        <input
            name="image"
            type="file"
            accept="image/*"
            class="w-full p-2 mb-4 rounded border bg-white text-gray-900"
        ...
        <select class="w-full p-2 mb-4 rounded border bg-white text-gray-900" name="type_id">
