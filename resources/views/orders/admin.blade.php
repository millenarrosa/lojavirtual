<x-app-layout>
    <div class="bg-white p-6 rounded-lg shadow">
        <h1 class="text-2xl font-bold text-gray-900 mb-6">Todos os Pedidos</h1>
        ...
        @forelse($orders as $order)
            <div class="border border-gray-200 rounded-lg mb-4 p-4">
                <div class="flex justify-between items-center mb-3">
                    ...
                    <span class="text-sm text-gray-600">Cliente: {{ $order->user->name }}</span>
        ...
        @empty
            <p class="text-gray-500 text-center py-10">Nenhum pedido encontrado.</p>
        @endforelse
    </div>
</x-app-layout>
